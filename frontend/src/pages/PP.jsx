      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              <span className="block text-green-600 dark:text-green-400">DevTrack</span>
              <span className="block text-gray-900 dark:text-white">Privacy Policy</span>
            </motion.h1>
            <motion.p
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                DevTrack ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our service that integrates with Google Calendar API and stores your competitive programming profiles.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                DevTrack's use and transfer to any other app of information received from Google APIs will adhere to <a href="https://developers.google.com/terms/api-services-user-data-policy" className="text-green-500 hover:underline" target="_blank" rel="noopener noreferrer">Google API Services User Data Policy</a>, including the Limited Use requirements.
              </p>
              <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-100 dark:border-green-900">
                <h3 className="font-semibold text-green-800 dark:text-green-200 mb-2">Limited Use Disclosure:</h3>
