...
import logo from '../../images/DevTrack_nobg.png';
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0">
                return <img src={logo} width={85} height={85} alt="Company Logo" className="mt-4 ml-15" />
                {/* <span className="text-2xl font-bold text-green-600 dark:text-green-400">DevTrack</span> */}
              </div>
              <div className="hidden md:block">
                <div className="ml-7 flex items-baseline space-x-4">
                  <a href="#" className="text-gray-800 dark:text-gray-200 hover:text-green-600 dark:hover:text-green-400 px-3 py-2 rounded-md font-medium">Home</a>
                  <a href="#features" className="text-gray-600 dark:text-gray-400 hover:text-green-600 dark:hover:text-green-400 px-3 py-2 rounded-md font-medium">Features</a>
                </div>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <a href="/login" className="text-green-600 dark:text-green-400 hover:text-green-700 dark:hover:text-green-300 font-medium">Login</a>
              <a href="/signup" className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-md font-medium transition-colors duration-300">Sign Up</a>
            </div>
          </div>
        </div>
      </nav>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              ...
              <span className="block text-green-600 dark:text-green-400">Competitive Coding</span>
            </motion.h1>
            <motion.p
              className="mt-3 max-w-md mx-auto text-base text-gray-500 dark:text-gray-400 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl"
              variants={itemVariants}
            >
              DevTrack unifies your competitive coding profiles, tracks your progress, and keeps you updated on all upcoming contests across platforms - all in one place.
            </motion.p>
            <motion.div
            ...
            >
              <div className="rounded-md shadow">
                <a href="/signup" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-green-600 hover:bg-green-700 md:py-4 md:text-lg md:px-10 transition-colors duration-300">
                  Get Started Free
                </a>
              </div>
              <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                <a href="#features" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-green-600 bg-white hover:bg-gray-50 dark:text-green-400 dark:bg-gray-800 dark:hover:bg-gray-700 md:py-4 md:text-lg md:px-10 transition-colors duration-300">
                  Explore Features
                </a>
              </div>
            </motion.div>
